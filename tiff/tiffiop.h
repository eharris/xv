...
#if SUBIFD_SUPPORT
#define	TIFF_INSUBIFD		0x400	/* currently writing a subifd */
...
#undef howmany
#endif
#define	howmany(x, y)	((((uint32)(x))+(((uint32)(y))-1))/((uint32)(y)))
#ifdef roundup
#undef roundup
#endif
...
extern	int _TIFFmemcmp(const void*, const void*, size_t);
